                    ...
                    <div class="card bg-dark border-success">
                        <div class="card-body py-5">
                            ...
                            <div class="d-flex gap-2 justify-content-center flex-wrap">
                                ...
                                <a href="/priority" class="btn btn-outline-info"><i class="fas fa-bullseye me-2"></i>Priority Inbox</a>
                                <a href="/compose-voice" class="btn btn-outline-warning"><i class="fas fa-microphone me-2"></i>Voice Compose</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-5">
                    <div class="row text-start">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="card bg-dark h-100">
                                <div class="card-body">
                                    <h6><i class="fas fa-tags me-2"></i>Smart Labeling</h6>
                                    <small class="text-muted">Automatic labeling and organization of your emails</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4">
